...
```{r}
cp <- fit2$cp
plot(cp[,2], cp[,3], typle="l", xlab="Size of tree (number of nodes", ylab="Out of sample error (%)", main="Figure 4: Relationship between tree size and out of sample error")
```
...
p2 <- predict(fit2, newdata=test.s, type="class")
pml_write_files(p2)
```
